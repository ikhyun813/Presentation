...
**Background**  
In 2018, the United States launched a trade war with China, aiming to economically decouple — especially in strategic sectors like semiconductors, aircraft parts, and telecommunications.
...
- Whether U.S. allies **reduced strategic imports** from China after 2018
- Uses interaction terms: `Post-2018 × Country`
...
<div style="flex: 1; font-size: 26px; color: #003049; padding-top: 10px; line-height: 1.6;">


→ Post-2018 interaction terms reflect each country’s deviation from U.S. behavior.
<br>
<br>
🟢 Positive coefficients = increased imports post-2018 (divergence)
<br>
...
# Render table
kable(robust_df, format = "html", caption = "Robust SEs (HC1): Post-2018 Effects by Country") %>%
